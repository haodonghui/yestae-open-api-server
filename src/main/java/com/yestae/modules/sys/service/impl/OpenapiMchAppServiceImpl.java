...
import com.yestae.modules.sys.dao.OpenapiMchAppDao;
 ...
 */
@Service("openapiMchAppService")
//@DataSource("slave1")
public class OpenapiMchAppServiceImpl extends ServiceImpl<OpenapiMchAppDao, OpenapiMchAppEntity> implements OpenapiMchAppService {
//	private Logger logger = LoggerFactory.getLogger(getClass());
	...
	@Override
	public void update(OpenapiMchAppEntity openapiMchApp) {
		// TODO Auto-generated method stub
		
	}

	@Override
	public OpenapiMchAppEntity selectByAppCode(String appCode) {
		if(appCode!=null){
			return getOne(new QueryWrapper<OpenapiMchAppEntity>().eq("app_code", appCode));
		}
		return null;
	}
