...
public final class XXTEA {
    ...
    public static void main(String[] args) {
    	...
    	jb.put("username", "yyz杨一舟");
    	String name = jb.toString();
    	String key = "key";
		String encryptV = encryptToBase64String(name,key);
		System.out.println(encryptV);
		System.out.println(decryptBase64StringToString(encryptV,key));
	}
    
    public static String decryptencrypt(String encrypt, String key) {
    	String decry = decryptBase64StringToString(encrypt,key);
    	String encry = encryptToBase64String(decry,key);
    	return encry;
    }
